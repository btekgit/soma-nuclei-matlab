...
writeXYZR2txt('./results/ex1_detections_all.txt', floor([dt_ctr(:,1),dt_ctr(:,2),dt_ctr(:,3),floor(dt_pseudo_radius(dthitIx==1))]));
...
writeXYZR2txt('./results/ex1_detections_false.txt', floor([dt_ctr(dthitIx==0,1),dt_ctr(dthitIx==0,2),dt_ctr(dthitIx==0,3),floor(dt_pseudo_radius(dthitIx==1))]));
